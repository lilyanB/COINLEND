...
function LinkButton({ href, children }: LinkButtonProps) {
  return (
    <Link href={href}>
      <div className="py-7 px-24 shadow-2xl font-bold shadow-black bg-white hover:bg-amber-600 rounded-lg border-4 border-black">
        {children}
      </div>
    </Link>
  );
    ...
    <main>
      <div className="flex flex-col justify-center items-center h-screen">
        <div className="flex flex-col items-center space-y-40">
          <div className="py-7 px-24 bg-white rounded-lg shadow-2xl border-4 border-black text-center">
            <h1 className="text-4xl font-bold">BitLend</h1>
            <p>Lending protocol on Bitcoin</p>
          </div>
